...
<body>
  ...
  <section>
    ...
    <form action="/login" name="login" method="post">
      ...
      <br><br>
      <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=f695cebca11264fb77faae7cb782cf59&redirect_uri=http://localhost:8181/kakao/oauth">
