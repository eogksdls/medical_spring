...
<meta charset="UTF-8">
  ...
  <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=09df39d1711578a191c566b2be27393a"></script>
</head>
<body>
<section>
	<script>
			...
			$.ajax({
				...
				success: function(data){
					...
					for(let i=0;i<arr.length;i++){
						...
						htmlData += '<td>';
						htmlData += '<img style="width: 40%"src="'+arr[i].galWebImageUrl+'">';
						htmlData += '</td>';
						htmlData += '</tr>';
